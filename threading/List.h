...
/**
 * Creates a list with a unique identifier.  The identifier is a UUID which is used to do any operations on the list.
...
/**
 * Add an item to the list, the item must be a void pointer.  You can make a pointer to any object and cast it
 * to a void pointer.  It will add the item to end of the list.
...
/**
 * Add an item to the list at the specified index, the item must be a void pointer.  You can make a pointer to any object and cast it
 * to a void pointer.  It will add the item to location in the list that is specified
...
/**
 * Remove an item from the list, the item must be a void pointer.  You can make a pointer to any object and cast it
 * to a void pointer. It will remove the item specified from the list.
...
/**
 * Remove an item from the list at a given index. The function will return the item removed.
 * @param listIdentifier The list identifier for the list you want remove from.
...
/**
 * Sorts a list based on the function given, the function takes in two void pointers and return true if the first item
 * is less than or equal to the second, it returns false otherwise.
 * @param listIdentifier The list to sort
 * @param func A function which returns true if the first item is less than or equal to the second, false otherwise.
 */
